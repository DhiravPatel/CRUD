                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                  ...
                  <form  method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="id" id="id" placeholder="Autofill" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input  class="form-control" type="text" name="email" id="email" placeholder="johndoel@gmail.com"  required maxlength="100">
                    </div>
